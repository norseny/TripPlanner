...
class AccommodationForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'price': NumberInput(attrs=dict_of_textinput_attrs),
            'more_info': Textarea(
                attrs={'rows': 2, 'cols': '65',
                       'class': 'materialize-textarea form-control form-control-sm more-info'}),
        }
        exclude = ()
...
class ProfileForm(ModelForm, Form):
    ...
    class Meta:
        ...
        widgets = {
            'about_me': Textarea(
                attrs={'rows': '10', 'cols': '20', 'class': 'materialize-textarea form-control form-control-sm p-2'}),
